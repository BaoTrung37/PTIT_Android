...
public class CartFragmentOrderCompletedListAdapter extends RecyclerView.Adapter<CartFragmentOrderCompletedListAdapter.ViewHolder> {
    List<Order> orderList;
    CartFragmentOrderPresenter cartFragmentOrderPresenter;

    public CartFragmentOrderCompletedListAdapter(List<Order> orderList) {
    ...
    public ViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        View view = LayoutInflater.from(parent.getContext()).inflate(R.layout.item_fragment_cart_order_completed_list,parent,false);
    ...
    public class ViewHolder extends RecyclerView.ViewHolder implements View.OnClickListener{
        ...
        public ViewHolder(@NonNull View itemView) {
            ...
            btReview = itemView.findViewById(R.id.item_bt_review);
