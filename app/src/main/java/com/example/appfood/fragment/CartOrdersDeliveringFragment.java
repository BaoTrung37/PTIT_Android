...
public class CartOrdersDeliveringFragment extends Fragment implements IOrderDetailListener {

    RecyclerView recOrderDeliveringList;
    CartFragmentOrderDeliveringListAdapter cartFragmentOrderDeliveringListAdapter;
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        View view = inflater.inflate(R.layout.fragment_cart_ordersdelivering,container,false);
        return view;
    }
    ...
    private void setData() {
        cartFragmentOrderDeliveringListAdapter = new CartFragmentOrderDeliveringListAdapter(orderList);
        ...
        cartFragmentOrderDeliveringListAdapter.setCartFragmentOrderPresenter(cartFragmentOrderPresenter);
        recOrderDeliveringList.setLayoutManager(layoutManager);
        recOrderDeliveringList.setAdapter(cartFragmentOrderDeliveringListAdapter);
    }

    private void initId(View view) {
        recOrderDeliveringList = view.findViewById(R.id.recOderDeliveringList);
    }
...
//                                Log.d("order",order.getNote());
                                orderList.add(order);
                                cartFragmentOrderDeliveringListAdapter.setOrderList(orderList);
                            }
                        }
                    }
                });
